...
import 'ui/utils/hex_color.dart';
...
class Styles {
  ...
  static final buttonStyle = ButtonStyle(
      backgroundColor: MaterialStateProperty.all<Color>(
          Colors.black.withOpacity(0.5)), // Background color with transparency
      foregroundColor:
          MaterialStateProperty.all<Color>(Colors.white), // Text color
      padding: MaterialStateProperty.all<EdgeInsetsGeometry>(
        EdgeInsets.symmetric(
            vertical: 16, horizontal: 48), // Longer button padding
      ),
      ...
      elevation: MaterialStateProperty.all<double>(5), // Button elevation
  ...
  static final bodyMediumStyle = MaterialStateProperty.all<TextStyle>(
    TextStyle(
      fontFamily: FontNameDefault,
      fontWeight: FontWeight.normal,
      fontSize: bodyMediumTextSize,
